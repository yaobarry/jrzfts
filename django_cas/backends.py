...
class CASBackend(ModelBackend):
    ...
    def _verify(self, ticket, service):
        ...
        try:
            ...
            mail = response.getElementsByTagName('cas:mail')[0].firstChild.nodeValue
            department = response.getElementsByTagName('cas:department')[0].firstChild.nodeValue
            company = response.getElementsByTagName('cas:company')[0].firstChild.nodeValue
            employee = response.getElementsByTagName('cas:employee')[0].firstChild.nodeValue
